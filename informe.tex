...
Lo importante es que el peso representa costos, de ir de un vertice a otro, y el minimo camino en $V'$ representa el costo minimo de ir de $C'_x$ a un $C'_y$ sea cual sea el nodo y tenemos soluciones de más ya que tenemos W nodos que representan a una sola ciudad.
