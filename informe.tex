...
Como podemos observar tanto Bellman Ford como Dijkstra con prioridad muestran una correlación considerablemente menor a los algoritmos anteriores. De hecho en $Fig20$ se puede notar que el fit de Bellman Ford es observablemente malo.
