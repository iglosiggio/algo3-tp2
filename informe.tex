...
\begin{enumerate}
	...
	\item En el momento que mostramos el algoritmo para generar $F(G)$ de $G'$ hablamos de lo fuertemente dependiente que era del parametro $W$ sin embargo consideramos que realizar un análisis en detalle sobre este tema, fue un faltante que quedará pendiente.
\end{enumerate}
